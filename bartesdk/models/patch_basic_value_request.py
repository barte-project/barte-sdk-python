...
class PatchBasicValueRequest(BaseModel):
    """
    PatchBasicValueRequest
    """ # noqa: E501
    uuid_plan: Annotated[str, Field(strict=True)] = Field(alias="uuidPlan")
    basic_value_request: BasicValueRequest = Field(alias="basicValueRequest")
    bank_slip_description: Optional[StrictStr] = Field(default=None, alias="bankSlipDescription")
    __properties: ClassVar[List[str]] = ["uuidPlan", "basicValueRequest", "bankSlipDescription"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of basic_value_request
        if self.basic_value_request:
            _dict['basicValueRequest'] = self.basic_value_request.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "basicValueRequest": BasicValueRequest.from_dict(obj["basicValueRequest"]) if obj.get("basicValueRequest") is not None else None,
            "bankSlipDescription": obj.get("bankSlipDescription")
        })
        return _obj
