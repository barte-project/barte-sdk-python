...
class BuyerResponse(BaseModel):
    ...
    phone: StrictStr
    email: StrictStr
    alternative_email: Optional[StrictStr] = Field(default=None, alias="alternativeEmail")
    __properties: ClassVar[List[str]] = ["uuid", "document", "name", "countryCode", "phone", "email", "alternativeEmail"]
