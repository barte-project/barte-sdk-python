...
class FraudDataRequest(BaseModel):
    """
    FraudDataRequest
    """ # noqa: E501
    document: StrictStr
    ...
    email: StrictStr
    phone: StrictStr
    billing_address: BillingAddressRequest = Field(alias="billingAddress")
    __properties: ClassVar[List[str]] = ["document", "name", "email", "phone", "billingAddress"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "email": obj.get("email"),
            "phone": obj.get("phone"),
            "billingAddress": BillingAddressRequest.from_dict(obj["billingAddress"]) if obj.get("billingAddress") is not None else None
        })
        return _obj
