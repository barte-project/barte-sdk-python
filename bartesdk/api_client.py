...
from bartesdk.api_response import ApiResponse, T as ApiResponseT
import bartesdk.models
from bartesdk import rest
from bartesdk.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(bartesdk.models, klass)
