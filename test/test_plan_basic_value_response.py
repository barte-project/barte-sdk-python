...
class TestPlanBasicValueResponse(unittest.TestCase):
    """PlanBasicValueResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlanBasicValueResponse:
        """Test PlanBasicValueResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlanBasicValueResponse`
        """
        model = PlanBasicValueResponse()
        if include_optional:
            return PlanBasicValueResponse(
                type = 'MONTHLY',
                value = 1000,
                value_per_month = 100
            )
    ...
    def testPlanBasicValueResponse(self):
        """Test PlanBasicValueResponse"""
