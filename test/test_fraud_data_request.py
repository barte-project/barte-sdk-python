...
class TestFraudDataRequest(unittest.TestCase):
    """FraudDataRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FraudDataRequest:
        """Test FraudDataRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FraudDataRequest`
        """
        model = FraudDataRequest()
        if include_optional:
