...
class TestBulletResponse(unittest.TestCase):
    """BulletResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulletResponse:
        """Test BulletResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulletResponse`
        """
        model = BulletResponse()
        if include_optional:
