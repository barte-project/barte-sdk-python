...
class TestUpdateBuyerRequest(unittest.TestCase):
    """UpdateBuyerRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateBuyerRequest:
        """Test UpdateBuyerRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateBuyerRequest`
        """
        model = UpdateBuyerRequest()
        if include_optional:
    ...
    def testUpdateBuyerRequest(self):
        """Test UpdateBuyerRequest"""
