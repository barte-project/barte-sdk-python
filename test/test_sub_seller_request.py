...
class TestSubSellerRequest(unittest.TestCase):
    """SubSellerRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubSellerRequest:
        """Test SubSellerRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubSellerRequest`
        """
        model = SubSellerRequest()
        if include_optional:
            return SubSellerRequest(
                name = '',
                document_type = '',
                document = '',
                phone_country_code = '',
