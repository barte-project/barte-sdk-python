...
class TestAddressSellerClientRequest(unittest.TestCase):
    """AddressSellerClientRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddressSellerClientRequest:
        """Test AddressSellerClientRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddressSellerClientRequest`
        """
        model = AddressSellerClientRequest()
        if include_optional:
            return AddressSellerClientRequest(
                country = 'ok',
                state = '',
                city = '',
                district = '',
    ...
    def testAddressSellerClientRequest(self):
        """Test AddressSellerClientRequest"""
