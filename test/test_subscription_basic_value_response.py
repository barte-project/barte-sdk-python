...
class TestSubscriptionBasicValueResponse(unittest.TestCase):
    """SubscriptionBasicValueResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionBasicValueResponse:
        """Test SubscriptionBasicValueResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionBasicValueResponse`
        """
        model = SubscriptionBasicValueResponse()
        if include_optional:
            return SubscriptionBasicValueResponse(
                type = 'MONTHLY',
                value = 1000,
                value_per_month = 100
            )
    ...
    def testSubscriptionBasicValueResponse(self):
        """Test SubscriptionBasicValueResponse"""
