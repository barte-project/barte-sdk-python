...
class TestBulletRequest(unittest.TestCase):
    """BulletRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulletRequest:
        """Test BulletRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulletRequest`
        """
        model = BulletRequest()
        if include_optional:
