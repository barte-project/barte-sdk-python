...
class TestAdditionalValueRequest(unittest.TestCase):
    """AdditionalValueRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdditionalValueRequest:
        """Test AdditionalValueRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdditionalValueRequest`
        """
        model = AdditionalValueRequest()
        if include_optional:
            return AdditionalValueRequest(
                value = 1000,
                installments = 5
            )
        else:
    ...
    def testAdditionalValueRequest(self):
        """Test AdditionalValueRequest"""
