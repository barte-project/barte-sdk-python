...
class TestBasicValueRequest(unittest.TestCase):
    """BasicValueRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BasicValueRequest:
        """Test BasicValueRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BasicValueRequest`
        """
        model = BasicValueRequest()
        if include_optional:
            return BasicValueRequest(
                type = 'MONTHLY',
    ...
    def testBasicValueRequest(self):
        """Test BasicValueRequest"""
