...
class TestPageOrderResponse(unittest.TestCase):
    """PageOrderResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageOrderResponse:
        """Test PageOrderResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageOrderResponse`
        """
        model = PageOrderResponse()
        if include_optional:
            return PageOrderResponse(
                ...
                size = 56,
                content = [
                    bartesdk.models.order_response.OrderResponse(
    ...
    def testPageOrderResponse(self):
        """Test PageOrderResponse"""
