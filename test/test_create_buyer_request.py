...
class TestCreateBuyerRequest(unittest.TestCase):
    """CreateBuyerRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateBuyerRequest:
        """Test CreateBuyerRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateBuyerRequest`
        """
        model = CreateBuyerRequest()
        if include_optional:
            return CreateBuyerRequest(
                ...
                address = bartesdk.models.address_seller_client_request.AddressSellerClientRequest(
                    country = 'ok', 
                    state = '', 
                    city = '', 
                    district = '', 
    ...
    def testCreateBuyerRequest(self):
        """Test CreateBuyerRequest"""
